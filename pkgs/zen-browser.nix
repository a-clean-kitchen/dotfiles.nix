...
let
  ...
  patchedSrc = buildNpmPackage {
    ...
    src = fetchFromGitHub {
      ...
      repo = "desktop";
      rev = zenVersion;
      hash = "sha256-UBQvcO2XLIIPImr5gLNUzZmJC+zflSV4/8x4P/791lI=";
    ...
    npmDepsHash = "sha256-UJmN8T0I0HxxL0/5X6IkraEFdOXTK+qihT+OTb/3JEg=";
