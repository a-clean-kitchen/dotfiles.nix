      ...
      functions = {
        ...
        rebuild-nixos = {
          body = ''
            ...
            and nixos-rebuild build $option --flake ${config.dotfilesPath}#${config.networking.hostName}
            and sudo ${config.dotfilesPath}/result/bin/switch-to-configuration switch
          '';
        };
        rebuild-home = {
          body = ''
